...
export default function MainMenu({ navigation }) { //  { navigation }
        ...
        <SafeAreaView style={gStyle.container}>
            <View style={gStyle.box11}>
                <View style={styles.container_main_menu}>
                    ...
                    <View style={styles.box11_1}>
                        <View style={styles.inner_1_contain}>
                            <TouchableOpacity onPress={loadSceneKalendar} style={styles.box11_100}>
                                <Image source={require('../assets/pic2.jpg')} style={styles.box11_100_calendar} />
                                <Text style={styles.box11_100_calendar_text}> Календарь </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={styles.box11_1}>
                        <View style={styles.inner_1_contain}>
                            <TouchableOpacity onPress={loadScenePobocka} style={styles.box11_100}>
                                <Image source={require('../assets/pic2.jpg')} style={styles.box11_100_calendar} />
                                <Text style={styles.box11_100_calendar_text}> Побочные эффекты </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={styles.box11_1}>
                        <View style={styles.inner_1_contain}>
                            <TouchableOpacity onPress={loadScenePomoschnik} style={styles.box11_100}>
                                <Image source={require('../assets/pic2.jpg')} style={styles.box11_100_calendar} />
                                <Text style={styles.box11_100_calendar_text}> Помощник </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={styles.box11_1}>
                        <View style={styles.inner_1_contain}>
                            <TouchableOpacity onPress={loadSceneKartaPreparatov} style={styles.box11_100}>
                                <Image source={require('../assets/pic2.jpg')} style={styles.box11_100_calendar} />
                                <Text style={styles.box11_100_calendar_text}> Карта препаратов </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
