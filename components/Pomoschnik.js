...
import FormKartaPreparatov from "./FormKartaPreparatov";

const gray = "#91A1BD";

export default function Pomoschnik({ navigation }) { //  { navigation }
            ...
            <View style={gStyle.box11}>
                <View style={styles.container_main_menu}>
                    ...
                    <View style={styles.container_kartapreparatov}>
                        <View style={styles.container_find_form}>
                            <Text style={styles.text_find}>Помощник</Text>
                        </View>
                        <View style={styles.container_find_table}>
                            {/*<Text style={styles.text_find}>Карта препаратов</Text>*/}
                            <ScrollView style={styles.scrollView}>
                                <Text style={styles.text_konsult}>
                        ...
                        <View style={styles.container_pomoschnik}>
                            {/*<FormKartaPreparatov addArticle={addArticleKartaPreparatov}/>*/}
                            <Text style={styles.text_find}>Смайлы</Text>
                            <Text style={styles.text_find}>Введите сообщение...</Text>
                            <Text style={styles.text_find}>Отправить</Text>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    scrollView: {
        ...
        marginHorizontal: 10,
        marginVertical: Platform.OS === "ios" ? -100 : -200,
        top: Platform.OS === "ios" ? 60 : 155,
    },
    ...
    container_find_btn: {
        flex: 1,
        justifyContent: 'space-between',
        top: Platform.OS === "ios" ? '27%' : '28.5%',
        left: Platform.OS === "ios" ? '3%' : '2%',
        // justifyContent: 'space-between',
        // flexDirection: 'row',
    },
    container_pomoschnik: {
        flex: 1,
        justifyContent: 'space-around',
        // justifyContent: 'space-evenly',
        // justifyContent: 'space-between',
        top: Platform.OS === "ios" ? '27%' : '42%',
        left: Platform.OS === "ios" ? '1.8%' : '1.4%',
        flexDirection: 'row',
        backgroundColor: 'pink',
        width: Platform.OS === "ios" ? '94.5%' : '95.5%',
        height: '1%',
    },
