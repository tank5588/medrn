...
declare const _default: React.ForwardRefExoticComponent<Pick<KeyboardTrackingViewProps, keyof ViewProps | "trackInteractive" | "revealKeyboardInteractive" | "manageScrollView" | "requiresSameParentToManageScrollView" | "allowHitsOutsideBounds" | "scrollToFocusedInput" | "scrollBehavior" | "addBottomView" | "bottomViewColor" | "useSafeArea" | "usesBottomTabs"> & React.RefAttributes<unknown>> & {
