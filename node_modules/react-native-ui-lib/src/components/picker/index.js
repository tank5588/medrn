...
const Picker = props => {
  ...
  return <PickerContext.Provider value={contextValue}>
      ...
      {...others} {...propsByFieldType} testID={`${testID}.input`} containerStyle={[paddings, margins, positionStyle, containerStyle, propsByFieldType?.containerStyle]} {...accessibilityInfo} importantForAccessibility={'no-hide-descendants'} value={label} selection={Constants.isAndroid ? {
        start: 0
      } : undefined}
