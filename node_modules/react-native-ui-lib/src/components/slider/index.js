...
export default class Slider extends PureComponent {
  ...
  _x_min = 0;
  lastDx = 0;
  initialValue = this.getRoundedValue(this.props.useRange ? this.props.maximumValue : this.props.value);
  minInitialValue = this.getRoundedValue(this.props.minimumValue);
