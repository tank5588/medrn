...
export class TextFieldDriver extends ComponentDriver {
  constructor(componentDriverArgs) {
    ...
    this.labelDriver = new TextDriver({ ...componentDriverArgs,
      testID: `${this.testID}.label`
    });
    this.validationMsgDriver = new TextDriver({ ...componentDriverArgs,
      testID: `${this.testID}.validationMessage`
    });
    this.floatingPlaceholderDriver = new TextDriver({ ...componentDriverArgs,
      testID: `${this.testID}.floatingPlaceholder`
    });
    this.charCounterDriver = new TextDriver({ ...componentDriverArgs,
  ...
  getLabelContent = () => this.labelDriver.getTextContent(); // validation message
  ...
  getValidationMsgContent = () => this.validationMsgDriver.getTextContent(); // char counter
